...
class HRAssessmentResult(BaseModel):
    ...
    transcript: Optional[str] = Field(default=None, description="Whisper-generated or provided transcript text")
    granular_voice_features: Optional[Dict[str, Any]] = Field(default=None, description="All granular voice features")
    emotion_timeline_rich: Optional[List[Dict[str, Any]]] = Field(default=None, description="Per-segment emotion timeline")
    emotion_summary: Optional[Dict[str, Any]] = Field(default=None, description="Aggregated emotion stats for LLM")
